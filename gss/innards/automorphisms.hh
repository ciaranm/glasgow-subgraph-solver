...
namespace gss::innards
{
    ...
    auto coset_reps(const InputGraph &i , std::vector<int> & orbit_sizes) -> std::vector<std::vector<unsigned int>>;
    auto coset_reps(const InputGraph &i, std::vector<int> & orbit_sizes, std::vector<int> base) -> std::vector<std::vector<unsigned int>>;
